...
rclpy_create_guard_condition(PyObject * Py_UNUSED(self), PyObject * args)
{
  ...
  rcl_context_t * context = rclpy_handle_get_pointer(pycontext, "rcl_context_t");
  if (!context) {
    return NULL;
  }
...
rclpy_trigger_guard_condition(PyObject * Py_UNUSED(self), PyObject * args)
{
  ...
  rcl_guard_condition_t * gc = rclpy_handle_get_pointer(
...
rclpy_get_node_name(PyObject * Py_UNUSED(self), PyObject * args)
{
  ...
  rcl_node_t * node = rclpy_handle_get_pointer(pynode, "rcl_node_t");
  if (!node) {
    return NULL;
  }
...
rclpy_publish(PyObject * Py_UNUSED(self), PyObject * args)
{
  ...
  rclpy_publisher_t * pub = (rclpy_publisher_t *)rclpy_handle_get_pointer(
...
rclpy_publisher_get_subscription_count(PyObject * Py_UNUSED(self), PyObject * args)
{
  ...
  const rclpy_publisher_t * pub = (rclpy_publisher_t *)rclpy_handle_get_pointer(
    pypublisher, "rclpy_publisher_t");
  if (!pub) {
    return NULL;
  }
...
rclpy_create_timer(PyObject * Py_UNUSED(self), PyObject * args)
{
  ...
  rcl_context_t * context = (rcl_context_t *)rclpy_handle_get_pointer(pycontext, "rcl_context_t");
  if (!context) {
    return NULL;
  }

  rcl_clock_t * clock = (rcl_clock_t *) rclpy_handle_get_pointer(pyclock, "rcl_clock_t");
  if (!clock) {
    return NULL;
  }
...
rclpy_get_timer_period(PyObject * Py_UNUSED(self), PyObject * args)
{
  ...
  rcl_timer_t * timer = (rcl_timer_t *)rclpy_handle_get_pointer(pytimer, "rcl_timer_t");
  if (!timer) {
    return NULL;
  }
...
{
  rclpy_subscription_t * sub = (rclpy_subscription_t *)p;
  if (!sub) {
    // Warning should use line number of the current stack frame
    int stack_level = 1;
    PyErr_WarnFormat(
...
rclpy_create_subscription(PyObject * Py_UNUSED(self), PyObject * args)
{
  ...
  rcl_node_t * node = (rcl_node_t *)rclpy_handle_get_pointer(pynode, "rcl_node_t");
  if (!node) {
    return NULL;
  }
...
{
  rclpy_client_t * cli = (rclpy_client_t *)p;
  if (!cli) {
...
rclpy_send_request(PyObject * Py_UNUSED(self), PyObject * args)
{
  ...
  rclpy_client_t * client = (rclpy_client_t *)rclpy_handle_get_pointer(pyclient, "rclpy_client_t");
  if (!client) {
    return NULL;
  }
...
{
  rclpy_service_t * srv = (rclpy_service_t *)p;
  if (!srv) {
    // Warning should use line number of the current stack frame
    int stack_level = 1;
    PyErr_WarnFormat(
...
rclpy_send_response(PyObject * Py_UNUSED(self), PyObject * args)
{
  ...
  rclpy_service_t * srv = (rclpy_service_t *)rclpy_handle_get_pointer(pyservice, "rclpy_service_t");
  if (!srv) {
    return NULL;
  }
...
rclpy_wait_set_add_entity(PyObject * Py_UNUSED(self), PyObject * args)
{
  ...
  if (0 == strcmp(entity_type, "subscription")) {
    rclpy_subscription_t * sub =
      (rclpy_subscription_t *)rclpy_handle_get_pointer(pyentity, "rclpy_subscription_t");
    if (!sub) {
      return NULL;
    }
    ...
    rclpy_client_t * client =
      (rclpy_client_t *)rclpy_handle_get_pointer(pyentity, "rclpy_client_t");
    if (!client) {
      return NULL;
    }
    ...
    rclpy_service_t * srv =
      (rclpy_service_t *)rclpy_handle_get_pointer(pyentity, "rclpy_service_t");
    if (!srv) {
      return NULL;
    }
    ...
    rcl_timer_t * timer =
      (rcl_timer_t *)rclpy_handle_get_pointer(pyentity, "rcl_timer_t");
    if (!timer) {
      return NULL;
    }
    ...
    rcl_guard_condition_t * guard_condition =
      (rcl_guard_condition_t *)rclpy_handle_get_pointer(pyentity, "rcl_guard_condition_t");
    if (!guard_condition) {
      return NULL;
    }
    ret = rcl_wait_set_add_guard_condition(wait_set, guard_condition, &index);
  } else if (0 == strcmp(entity_type, "event")) {
    rcl_event_t * event = (rcl_event_t *)rclpy_handle_get_pointer(pyentity, "rcl_event_t");
...
rclpy_take(PyObject * Py_UNUSED(self), PyObject * args)
{
  ...
  rclpy_subscription_t * sub =
    (rclpy_subscription_t *)rclpy_handle_get_pointer(pysubscription, "rclpy_subscription_t");
  if (!sub) {
    return NULL;
  }
...
rclpy_take_request(PyObject * Py_UNUSED(self), PyObject * args)
{
  ...
  rclpy_service_t * srv =
    (rclpy_service_t *)rclpy_handle_get_pointer(pyservice, "rclpy_service_t");
  if (!srv) {
    return NULL;
  }
...
rclpy_take_response(PyObject * Py_UNUSED(self), PyObject * args)
{
  ...
  rclpy_client_t * client = rclpy_handle_get_pointer(pyclient, "rclpy_client_t");
  if (!client) {
    return NULL;
  }
...
rclpy_assert_liveliness(PyObject * Py_UNUSED(self), PyObject * args)
{
  ...
  if (PyCapsule_IsValid(pyentity, "rcl_node_t")) {
    rcl_node_t * node = rclpy_handle_get_pointer(pyentity, "rcl_node_t");
    ...
    rclpy_publisher_t * publisher = rclpy_handle_get_pointer(
...
rclpy_clock_get_now(PyObject * Py_UNUSED(self), PyObject * args)
{
  ...
  rcl_clock_t * clock = rclpy_handle_get_pointer(
    pyclock, "rcl_clock_t");
  if (!clock) {
    return NULL;
  }
...
rclpy_add_clock_callback(PyObject * Py_UNUSED(self), PyObject * args)
{
  ...
  rcl_clock_t * clock = rclpy_handle_get_pointer(pyclock, "rcl_clock_t");
  if (!clock) {
    return NULL;
  }
...
rclpy_get_node_parameters(PyObject * Py_UNUSED(self), PyObject * args)
{
  ...
  rcl_node_t * node = rclpy_handle_get_pointer(node_capsule, "rcl_node_t");
  if (!node) {
    return NULL;
  }
